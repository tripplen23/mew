...
#[openapi(
    ...
    paths(
        ...
        routes::providers::connect_provider,
        routes::providers::provider_status,
    ...
    components(
        schemas(
            ...
            mewcode_protocol::credential::ProviderStatus,
            mewcode_protocol::event::ChatRequest,
            mewcode_protocol::event::ChoiceResponseRequest,
            mewcode_protocol::event::ReviewRequest,
            mewcode_protocol::event::ReviewResponse,
